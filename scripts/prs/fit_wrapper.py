"""Fit wrapper model with PRSice-2 scores.

Args:
	-p, --pheno-file: Path to phenotype file.
	-c, --covar-file: Path to covariate file.
	-s, --score-file: Path to PRSice-2 score file.
...
def parse_args():
	...
	parser.add_argument("-c", "--covar-file", required=True)
